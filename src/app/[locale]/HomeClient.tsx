      ...
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 lg:px-8 pt-36 pb-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            {/* Headline */}
            <h1 className="font-display text-[clamp(2.2rem,4.8vw,4.2rem)] font-extralight leading-[1.06] tracking-tight text-white">
              {t('heroTitle')}
              <br />
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        <AnimatedSection>
          ...
          <h2 className="font-display mt-4 max-w-2xl text-[clamp(1.6rem,3vw,2.5rem)] font-light leading-tight text-navy-900">
            {t('gatewayTitle')}
          </h2>
          <p className="mt-5 max-w-2xl text-[1rem] leading-relaxed text-navy-800/80 font-light">
            {t('gatewaySubtitle')}
          </p>
        </AnimatedSection>

        <div className="mt-16 grid gap-px bg-gray-200 sm:grid-cols-2 lg:grid-cols-4">
          {pillars.map((pillar, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <div className="bg-white p-9 lg:p-10 h-full flex flex-col">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gold-50 text-gold-500 mb-6 flex-shrink-0">
                  {pillar.icon}
                </div>
                <h3 className="text-[15.5px] font-semibold text-navy-900">
                  {t(pillar.titleKey)}
                </h3>
                <p className="mt-3 text-[14px] leading-relaxed text-navy-800/80 flex-1">
                  {t(pillar.descKey)}
                </p>
              </div>
            </AnimatedSection>
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <AnimatedSection>
            ...
            <h2 className="font-display mt-4 text-[clamp(1.6rem,3vw,2.5rem)] font-light leading-tight text-white">
              {t('corridorTitle')}
            </h2>
    ...
    <section className="bg-navy-950">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        <AnimatedSection>
          ...
          <h2 className="font-display mt-4 max-w-2xl text-[clamp(1.6rem,3vw,2.5rem)] font-light leading-tight text-white">
            {t('ecosystemTitle')}
          </h2>
        ...
        <div className="mt-16 grid gap-px bg-white/[0.06] sm:grid-cols-3">
          {partners.map((p, i) => (
            <AnimatedSection key={i} delay={i * 0.12}>
              <div className="bg-navy-950 p-9 lg:p-10 h-full flex flex-col">
                {/* Header */}
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        ...
        <div className="mt-16 grid gap-px bg-gray-200 sm:grid-cols-3">
          {funds.map((f, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <div className="bg-white p-9 lg:p-10 h-full flex flex-col">
                {/* Platform badge */}
                <div
                  className="inline-flex items-center gap-2 mb-6 pb-5 border-b w-full border-gray-200"
                >
                  <div
                  ...
                  />
                  <div>
                    <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-navy-900">
                      {f.platform}
                    </div>
                    <div className="text-[10px] text-navy-900/60">{f.platformCn}</div>
                  </div>
                </div>

                {/* Fund name */}
                <h3 className="text-[15.5px] font-semibold text-navy-900 leading-snug">
                  {f.name}
                </h3>
                <p className="mt-1 text-[12px] text-navy-900/60">{f.code}</p>
                ...
                <ul className="mt-5 space-y-2.5 flex-1">
                  {f.details.map((d, di) => (
                    <li key={di} className="flex gap-2.5 items-start">
                      <span className="text-[8px] mt-[5px] text-navy-900/60 flex-shrink-0">◆</span>
                      <span className="text-[13.5px] leading-relaxed text-navy-900/80">{d.text}</span>
                    </li>
                  ))}
                </ul>
                ...
                {/* Size */}
                <div
                  className="mt-6 pt-5 border-t border-gray-200 text-[12px] font-semibold uppercase tracking-[0.12em]"
                  style={{ color: f.accentColor }}
                >
                  {f.sizeLabel}
                </div>
  ...
  return (
    <section className="bg-gray-50">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        ...
        {/* Portfolio grid */}
        <div className="mt-8 grid gap-px bg-gray-200 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
            ...
            return (
              <AnimatedSection key={i} delay={i * 0.04}>
                <div className="bg-white px-6 py-5 h-full flex flex-col justify-between">
                  <div>
                    <div className="text-[15.5px] font-semibold text-navy-900">
                      {locale === 'en' ? item.en : item.zh}
                    </div>
                    <div className="text-[12px] text-navy-900/60 mt-0.5">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-medium uppercase tracking-wider text-navy-900/60">
                      {item.exchange}
                    </span>
                  </div>
                </div>
        ...
        <p className="mt-8 text-[12px] text-navy-900/60">{t('trackNote')}</p>
      </div>
    </section>
  );
}
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
          ...
          {divisions.map((div, i) => (
            <AnimatedSection key={div.divisionId} delay={i * 0.07}>
              <Link
                ...
                className="group flex h-full flex-col justify-between bg-white p-9 transition-all ease-in-out duration-300 hover:bg-gray-100 hover:-translate-y-1 lg:p-10"
              >
                <div>
                  <h3 className="text-[18px] font-semibold text-navy-900">
                    {loc(div, 'title', locale)}
                  </h3>
                  <p className="mt-3 text-[14px] leading-relaxed text-navy-800/80">
        ...
        <div className="mt-10">
          <AnimatedSection>
            <Link
              href="/business"
              className="inline-flex items-center gap-2 text-[11.5px] font-medium uppercase tracking-[0.09em] text-navy-900 hover:text-gold-500 transition-colors"
            >
              {t('businessViewAll')}
    ...
    <section className="bg-navy-950">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        ...
        <AnimatedSection>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
            <div>
              ...
              <h2 className="font-display mt-4 max-w-xl text-[clamp(1.6rem,3vw,2.5rem)] font-light leading-tight text-white">
                {t('lpTitle')}
              </h2>
            </div>
        ...
        <div className="grid gap-px bg-white/[0.05] sm:grid-cols-3">
          {paths.map((p, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <Link href={p.href} className="group bg-navy-950 p-9 lg:p-10 h-full flex flex-col hover:bg-navy-900 transition-colors cursor-pointer">
                <div className="flex items-start justify-between mb-6">
        ...
        <AnimatedSection delay={0.3}>
          <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.04]">
            {requirements.map((r, i) => (
              <div key={i} className="bg-navy-950 px-6 py-5">
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        <div className="grid items-start gap-16 lg:grid-cols-2">
          <AnimatedSection>
            ...
            <p className="mt-6 text-[clamp(1rem,1.8vw,1.2rem)] font-light leading-relaxed text-navy-900/80">
              {t('aboutDescription')}
            </p>
            <Link
              href="/about"
          ...
          <AnimatedSection delay={0.15}>
            <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-navy-900/60 mb-8">
              {t('aboutGlobalPresence')}
            </p>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {offices.map((office) => (
                <div key={office.city} className="border-l-2 border-gold-400 py-3 pl-4">
                  <div className="text-[15px] font-semibold text-navy-900">{office.city}</div>
                  <div className="text-[11px] uppercase tracking-widest text-navy-900/60 mt-0.5">{office.role}</div>
                </div>
              ))}
            </div>
          </AnimatedSection>
  ...
  return (
    <section className="section-separator bg-white">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-28 lg:py-36">
        <AnimatedSection>
          <div className="flex items-end justify-between">
            <div>
              ...
              <h2 className="font-display mt-4 text-[clamp(1.5rem,3vw,2.25rem)] font-light text-navy-900">
                {t('insightsSubtitle')}
              </h2>
            </div>
            <Link
        ...
        <div className="mt-12 grid gap-px bg-gray-200 md:grid-cols-3">
          {latest.map((article, i) => (
            <AnimatedSection key={article.slug} delay={i * 0.1}>
              <Link
                href={`/insights/${article.slug}`}
                className="group flex h-full flex-col justify-between bg-white p-8 transition-colors hover:bg-gray-100"
              >
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] text-navy-900/60">{article.date}</span>
                  </div>
                  <h3 className="mt-4 text-[17px] font-semibold leading-snug text-navy-900 group-hover:text-navy-700">
                    {loc(article, 'title', locale)}
                  </h3>
                  <p className="mt-3 line-clamp-3 text-[14px] leading-relaxed text-navy-800/80">
    ...
    <section className="bg-navy-950">
      <div className="mx-auto flex max-w-[1400px] flex-col items-start justify-between gap-8 px-6 lg:flex-row lg:items-center lg:px-8 py-24 lg:py-28">
        <div className="max-w-xl">
          <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-light text-white">{t('ctaTitle')}</h2>
