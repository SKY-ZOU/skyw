        ...
        <div className="mt-12 grid gap-px bg-[#e5e7eb] md:grid-cols-2">
          <AnimatedSection delay={0.1}>
            <div className="bg-[#fafafa] p-10 lg:p-14">
              ...
              <p className="mt-3 text-body leading-relaxed text-[#6c757d]">{t('license6Desc')}</p>
            </div>
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            <div className="bg-[#fafafa] p-10 lg:p-14">
              ...
              <p className="mt-3 text-body leading-relaxed text-[#6c757d]">{t('license9Desc')}</p>
            </div>
          </AnimatedSection>
        </div>
        <p className="mt-8 text-body-sm text-[#adb5bd]">{t('licensesNote')}</p>
      </div>
    </section>
  );
}
