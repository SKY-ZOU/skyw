...
export const INSTITUTIONAL_UNITS: InstitutionalUnit[] = [
  {
    ...
    relationshipLabel: { zh: '旗下自持 · 香港持牌管理人', en: 'Subsidiary · HK Licensed Manager' },
    owner: { zh: '天汇基金 SKYW Fund', en: 'SKYW Fund (HK)' },
    ownerBadge: 'SFC Type 4 · Type 9 · BOP785',
    ownerHighlight: {
      zh: '天際控股集團旗下全資子公司 · 香港 SFC 持牌資產管理人',
      en: 'Wholly-owned subsidiary of SKYW Group · SFC-licensed HK asset manager',
    },
    ownerStats: [
      { v: '$1B+', l: 'AUM' },
      { v: '6+', l: 'Strategies' },
    ...
    platformLicense: 'SFC Type 4 · Type 9 · BOP785',
